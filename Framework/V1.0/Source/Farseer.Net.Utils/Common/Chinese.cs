...
namespace FS.Utils.Common
{
    ...
    public abstract class Chinese
    {
        ...
        ///     包含字符 ASC 码的整形数组。
        /// </summary>
        private static readonly int[] pv = new[]
                                               {
                                                   -20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257,
                                                   -20242,
                                                   -20230, -20051, -20036, -20032, -20026, -20002, -19990, -19986,
                                                   -19982,
                                                   -19976, -19805, -19784, -19775, -19774, -19763, -19756, -19751,
                                                   -19746,
                                                   ...
                                                   -18490,
                                                   -18478, -18463, -18448, -18447, -18446, -18239, -18237, -18231,
                                                   -18220,
                                                   -18211, -18201, -18184, -18183, -18181, -18012, -17997, -17988,
                                                   -17970,
                                                   ...
                                                   -16401,
                                                   -16393, -16220, -16216, -16212, -16205, -16202, -16187, -16180,
                                                   -16171,
                                                   -16169, -16158, -16155, -15959, -15958, -15944, -15933, -15920,
                                                   -15915,
                                                   ...
                                                   -14921,
                                                   -14914, -14908, -14902, -14894, -14889, -14882, -14873, -14871,
                                                   -14857,
                                                   -14678, -14674, -14670, -14668, -14663, -14654, -14645, -14630,
                                                   -14594,
                                                   ...
                                                   -13367,
                                                   -13359, -13356, -13343, -13340, -13329, -13326, -13318, -13147,
                                                   -13138,
                                                   -13120, -13107, -13096, -13095, -13091, -13076, -13068, -13063,
                                                   -13060,
                                                   ...
                                                   -11018,
                                                   -11014, -10838, -10832, -10815, -10800, -10790, -10780, -10764,
                                                   -10587,
                                                   -10544, -10533, -10519, -10331, -10329, -10328, -10322, -10315,
                                                   -10309,
        ...
        ///     包含汉字拼音的字符串数组。
        /// </summary>
        private static readonly string[] ps = new[]
                                                  {
                                                      ...
                                                      "quan"
                                                      , "que", "qun", "ran", "rang", "rao", "re", "ren", "reng", "ri",
                                                      ...
                                                      "tao",
                                                      "te", "teng", "ti", "tian", "tiao", "tie", "ting", "tong", "tou",
                                                      "tu", "tuan", "tui", "tun", "tuo", "wa", "wai", "wan", "wang",
                                                      "wei",
                                                      "wen", "weng", "wo", "wu", "xi", "xia", "xian", "xiang", "xiao",
                                                      "xie", "xin", "xing", "xiong", "xiu", "xu", "xuan", "xue", "xun",
                                                      "ya", "yan", "yang", "yao", "ye", "yi", "yin", "ying", "yo",
                                                      "yong",
                                                      "you", "yu", "yuan", "yue", "yun", "za", "zai", "zan", "zang",
                                                      "zao",
                                                      "ze", "zei", "zen", "zeng", "zha", "zhai", "zhan", "zhang", "zhao"
                                                      ,
        ...
        public static string Convert(string chs, string separator = "", bool initialCap = false)
        {
            ...
            // 例外词组
            chs = Phrase.Cast<DictionaryEntry>().Aggregate(chs, (current, de) => current.Replace(de.Key.ToString(), String.Format(" {0} ", de.Value.ToString().Replace(" ", separator))));
            var returnstr = "";
            var b = false;
        ...
        public static string GetRandomChinese(int strlength)
        {
            ...
            {
                var temp = gb.GetString((byte[])System.Convert.ChangeType(bytes[i], typeof(byte[])));
                sb.Append(temp);
            }
        ...
        private static object[] CreateRegionCode(int strlength)
        {
            ...
            **/
            for (var i = 0; i < strlength; i++)
            {
                ...
                var byte1 = System.Convert.ToByte(str_r1 + str_r2, 16);
                var byte2 = System.Convert.ToByte(str_r3 + str_r4, 16);
                // 将两个字节变量存储在字节数组中 
                var str_r = new byte[] { byte1, byte2 };
