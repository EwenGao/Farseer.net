...
namespace FS.Extend
{
    ...
    public static class ExtendExtend
    {
        ...
        {
            var orm = ModelCache.GetInfo(typeof(T));
            var list = new List<T>();
            Type type;
        ...
        public static T ToInfo<T>(this DataRow dr) where T : BaseInfo, new()
        {
            var map = ModelCache.GetInfo(typeof(T));
        ...
        /// <typeparam name="T">实体类</typeparam>
        public static List<T> ToList<T>(this DataSet ds) where T : BaseInfo, new()
        {
        ...
        ///     检查是否存在该类型的子窗体
        /// </summary>
        /// <param name="form">Windows窗体对像</param>
        ...
        ///     转换成Json格式 x=x&x=x
        /// </summary>
        /// <param name="dic">Dictionary对像</param>
        /// <typeparam name="T1">Key</typeparam>
        /// <typeparam name="T2">Value</typeparam>
