...
function skinInit(swfuOption) {
    swfuOption["button_image_url"] = "FileType/FileList/button.jpg";
...
function uploadStarted(file) {
    ...
    document.getElementById("QynUploadQueue").scrollTop = document.getElementById(file.id).scrollHeight * (file.index - 1);
...
function insertHtml(file) {
    ...
    div += '        <a class="progressCancel" href="#" onclick="deleteQueue(\'' + file.id + '\') "><img src="FileType/FileList/del.png" /></a>';
